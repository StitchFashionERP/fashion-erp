...
export function ArticlesBulkDrawer({
  ...
  function save() {
    ...
    activeFields.forEach((key) => {
      ...
      if (key === "collection") changes.collection = value;
      if (key === "brand") changes.brand = value;
      if (key === "supplier") changes.supplier = value;
      if (key === "garmentType") changes.garmentType = value;
      if (key === "category") changes.category = value;
      if (key === "material") changes.material = value;
      if (key === "fit") changes.fit = value;
    });
    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          background: "#ffffff",
          boxShadow: "-14px 0 40px rgba(9, 30, 58, 0.2)",
        }}
      >
        <header
          style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: 24 }}>
          ...
          >
            Vink alleen de velden aan die je bij alle geselecteerde artikelen
            wilt overschrijven.
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    gap: 10,
                    padding: 12,
                    border: `1px solid ${active ? "#86b7e5" : "#dbe3ee"}`,
                    borderRadius: 6,
                    background: active ? "#f4f9fe" : "#ffffff",
                  }}
                >
                  <input
                    type="checkbox"
